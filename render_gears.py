...
class Gears:
    def __init__(self, teeth, pitch, angle):
        self.teeth = teeth
        self.pitch = pitch
        self.angle = angle  # Angle of tangent to tooth at circular pitch wrt radial line.

    def effect(self):
        teeth = self.teeth
        pitch = self.pitch
        angle = self.angle  # Angle of tangent to tooth at circular pitch wrt radial line.
